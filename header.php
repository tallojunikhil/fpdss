...
<html>
<head>
    <title><?= !empty($title) ? $title : "Police" ?></title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li><a href="#">Welcome to <?= $user['first_name'] . ' ' . $user['last_name'] ?></a></li>
            </ul>
            <ul class="nav navbar-nav navbar-right">
                ...
                <?php if ($_SESSION['ROLE'] == 'ADMIN') { ?>
                    ...
                    <li><a href="availebility.php">User Availability</a></li>
