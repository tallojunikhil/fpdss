...
if (isset($_POST['signup'])) {
    ...
    if($qq[0]==$answer){
        if($password==$repassword){
            $res = mysqli_query($link,"INSERT INTO `tbl_users` (`first_name`,`last_name`,`email`,`password`,`department`,`level`,`role`,`date_of_registration`) VALUES ('$first_name','$last_name','$email','$password','$department','$level','USER',NOW())");
            if($res==true){
