            ...
            if($number==0){
                ...
                for($i=1;$i<=$number;$i++){
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="jobs.php?jobs_id=<?= $list['jobs_id'] ?>" class="btn btn-sm btn-info"><i class="fa fa-edit"></i> </a>
                            <a href="jobs.php?del_id=<?= $list['jobs_id']; ?>" class="delete btn btn-sm btn-danger"><i class="fa fa-trash-o"></i></a>
                        </td>
                    </tr>
               <?php  }
                  }      ?>
