...
<section class="">
    ...
    <article class="signup-form">
        <div class="container">
            ...
            </div>-->			<div class="col-md-offset-3 col-md-4">                        <form class="form-horizontal front-form" id="form1" method="post">                            <div class="forgot-display"></div>                            <div class="col-md-12">                                <div class="form-group">                                    <label>Email ID</label>                                    <div class="input-group">                                        <span class="input-group-addon"><i class="fa fa-envelope-o"></i> </span>                                        <input type="email" class="form-control name" placeholder="Email ID" name="email" value="" required>                                    </div>                                </div>                                <div class="form-group">                                    <label>Security Question</label>                                    <div class="input-group">                                        <span class="input-group-addon"><i class="fa fa-question-circle"></i> </span>                                        <select class="form-control name" name="question_id" required>                                            <option value="">Select a question</option>                                            <?php                                            $questions = mysqli_query($link, "SELECT `question_id`,`question` FROM `tbl_questions` ORDER BY `question_id` DESC");                                            while ($question = mysqli_fetch_row($questions)) { ?>                                                <option value="<?= $question[0] ?>"><?= $question[1] ?></option>                                            <?php } ?>                                        </select>                                    </div>                                </div>                                <div class="form-group">                                    <label>Answer</label>                                    <div class="input-group">                                        <span class="input-group-addon"><i class="fa fa-reply"></i> </span>                                        <input class="form-control name" name="answer" required>                                    </div>                                </div>                                <button class="btn btn-info " type="submit">SEND</button>                                <button type="button" class="btn btn-danger login_cancel ">CANCEL</button>                            </div>                        </form>                    </div>					
        </div>
    </article>
</section>
</body>
