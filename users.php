            ...
            if($number==0){
                ...
                for($i=1;$i<=$number;$i++){
                    ...
                    <tr>
                        ...
                        <td><?= $list['level'] ?></td>
                        <td> <a href="users.php?status_id=<?= $list['user_id'] ?>&sta=<?= !empty($list['is_active']) ? "0" : "1"; ?>"><?= !empty($list['is_active']) ? "<div class=\"label label-success\"> Active</div>" : "<div class=\"label label-danger\">In Active</div>"; ?></a></td>
                        <td>
                            <a href="users.php?del_id=<?= $list['user_id']; ?>" class="delete btn btn-sm btn-danger"><i class="fa fa-trash-o"></i></a>
                        </td>
                    </tr>
                <?php  }
            }      ?>
