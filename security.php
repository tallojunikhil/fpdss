    ...
    <article>
        <div class="col-md-offset-3 col-md-6">
            ...
            <form method="post" class="form-horizontal">
                <input type="hidden"  name="jobs_id" value="<?= !empty($question_id) ? $question_id : ""; ?>"/>
                <div class="form-group">
                    <label class="col-md-4">Question</label>
                    <div class="col-md-8">
                        <input type="text" class="form-control" name="question" value="<?= !empty($question_id) ? $question['question'] : ""; ?>" required/>
                    </div>
                </div>
                <div class="form-group">
            ...
            if($number==0){
                ...
                for($i=1;$i<=$number;$i++){
                    ...
                    <tr>
                        ...
                        <td><?= $list['answer'] ?></td>
                        <td>
                            <a href="security.php?question_id=<?= $list['question_id'] ?>" class="btn btn-sm btn-info"><i class="fa fa-edit"></i> </a>
                            <a href="security.php?del_id=<?= $list['question_id']; ?>" class="delete btn btn-sm btn-danger"><i class="fa fa-trash-o"></i></a>
                        </td>
                    </tr>
                <?php  }
            }      ?>
