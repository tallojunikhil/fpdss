        ...
        <form class="form-horizontal" method="post">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <input class="form-control" name="first_name" placeholder="First Name" value="<?= !empty($user['first_name']) ? $user['first_name'] : ""; ?>" required>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-5">Last Name</label>
                    <div class="col-md-7">
                        <input class="form-control" name="last_name" placeholder="Last Name" value="<?= !empty($user['last_name']) ? $user['last_name'] : ""; ?>" required>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-5">Email ID</label>
                    <div class="col-md-7">
                        <input type="email" class="form-control" placeholder="Email ID" name="email" value="<?= !empty($user['email']) ? $user['email'] : ""; ?>" required readonly>
                    </div>
                </div>
                <!-- <div class="form-group">
                    <label class="col-md-5">Department ID</label>
                    <div class="col-md-7">
                        <input class="form-control" name="department" value="<?= !empty($user['department']) ? $user['department'] : ""; ?>" required readonly>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-5">Level</label>
                    <div class="col-md-7">
                        <input class="form-control" name="level" value="<?= !empty($user['level']) ? $user['level'] : ""; ?>" required readonly>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <input class="form-control" placeholder="Address 1" name="address1" value="<?= !empty($user['address1']) ? $user['address1'] : ""; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-5">Addredd 2</label>
                    <div class="col-md-7">
                        <input class="form-control"  placeholder="Address 2" name="address2" value="<?= !empty($user['address2']) ? $user['address2'] : ""; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-5">City</label>
                    <div class="col-md-7">
                        <input class="form-control" placeholder="City" name="city" value="<?= !empty($user['city']) ? $user['city'] : ""; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-5">State</label>
                    <div class="col-md-7">
                        <input class="form-control" placeholder="State" name="state" value="<?= !empty($user['state']) ? $user['state'] : ""; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-5">ZIP</label>
                    <div class="col-md-7">
                        <input class="form-control" placeholder="zip" name="zip" value="<?= !empty($user['zip']) ? $user['zip'] : ""; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-5">Mobile No</label>
                    <div class="col-md-7">
                        <input class="form-control" placeholder="Mobile No" name="mobile" value="<?= !empty($user['mobile']) ? $user['mobile'] : ""; ?>">
                    </div>
                </div>
